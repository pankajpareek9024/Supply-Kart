...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Update product details for <strong>{{ $product->name }}</strong></p>
    </div>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="unit" class="form-select" required>
                                @foreach (['pcs'=>'Pieces (pcs)','box'=>'Box','kg'=>'Kilogram (kg)','ltr'=>'Litre (ltr)','pack'=>'Pack','set'=>'Set'] as $val => $label)
        ...
        <div class="col-lg-4">
            <div class="admin-card mb-3">
                ...
                <div class="admin-card-body text-center">
                    @if($product->image)
                        <img id="productPreview" src="{{ Storage::url($product->image) }}"
                            class="mb-3" style="max-width:100%;border-radius:8px;max-height:200px;object-fit:contain;">
                    @else
            ...
            <div class="admin-card mb-3">
                ...
                <div class="admin-card-body">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_active" id="productStatus" value="1"
                            {{ $product->is_active ? 'checked' : '' }}>
                        <label class="form-check-label fw-600" for="productStatus">Active</label>
                    </div>
                </div>
            </div>
